...
class Transaction extends \App\Entities\Transaction implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'originalTransactionId' => [parent::class, 'originalTransactionId', null, 16],
        "\0".parent::class."\0".'payee' => [parent::class, 'payee', null, 16],
        ...
        'originalTransactionId' => [parent::class, 'originalTransactionId', null, 16],
        'payee' => [parent::class, 'payee', null, 16],
